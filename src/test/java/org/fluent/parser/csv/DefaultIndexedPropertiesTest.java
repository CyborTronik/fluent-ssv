...
import org.fluent.parser.csv.exception.InvalidDefaultCsvHeaderException;
import org.fluent.parser.csv.exception.InvalidSetPropertyIndexRequestException;
...
public class DefaultIndexedPropertiesTest {
	...
	@Test(expected = InvalidDefaultCsvHeaderException.class)
